...
public class DeviceList extends ListActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Set<BluetoothDevice> upareniUredaji =  myBluetoothAdapter2.getBondedDevices();
        if(upareniUredaji.size() > 0){
            for(BluetoothDevice upareni : upareniUredaji){
                String imeBt = upareni.getName();
                String macBt = upareni.getAddress();
                ArrayBluetooth.add(imeBt + "\n" + macBt);
            }
        }
